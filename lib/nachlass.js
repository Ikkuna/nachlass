...
/**
 * Initialize a new `Synonym space` with the given `key`.
 *
 * @param {String} key
 * @api public
 */

function Synonyms(info,opts) {
  this.key = key;
  this.client = exports.createClient();
  this.opts = opts;
}

Synonyms.prototype.add = function(list, fn){
  var key = this.key;
  var db = this.client;
  // var opts = this.opts;
...
function Search(key,info,opts) {
  ...
  Search.prototype.synonyms = function(list){
